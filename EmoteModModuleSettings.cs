...
namespace Celeste.Mod.EmoteMod
{
	...
	class EmoteBindings : OuiGenericMenu, OuiModOptions.ISubmenu // emote binds submenu class
	{
		...
		{
			menu.Add(new TextMenu.Button($"1. {EmoteModModule.Settings.emote0}").Pressed(() => {
				Audio.Play(SFX.ui_main_savefile_rename_start);
				menu.SceneAs<Overworld>().Goto<OuiModOptionString>().Init<OuiModOptions>(
					EmoteModModule.Settings.emote0,
					v => EmoteModModule.Settings.emote0 = v,
					12,
					1
				);
			}));

			menu.Add(new TextMenu.Button($"2. {EmoteModModule.Settings.emote1}").Pressed(() => {
				Audio.Play(SFX.ui_main_savefile_rename_start);
				menu.SceneAs<Overworld>().Goto<OuiModOptionString>().Init<OuiModOptions>(
					EmoteModModule.Settings.emote1,
					v => EmoteModModule.Settings.emote1 = v,
					12,
					1
				);
			}));

			menu.Add(new TextMenu.Button($"3. {EmoteModModule.Settings.emote2}").Pressed(() => {
				Audio.Play(SFX.ui_main_savefile_rename_start);
				menu.SceneAs<Overworld>().Goto<OuiModOptionString>().Init<OuiModOptions>(
					EmoteModModule.Settings.emote2,
					v => EmoteModModule.Settings.emote2 = v,
					12,
					1
				);
			}));

			menu.Add(new TextMenu.Button($"4. {EmoteModModule.Settings.emote3}").Pressed(() => {
				Audio.Play(SFX.ui_main_savefile_rename_start);
				menu.SceneAs<Overworld>().Goto<OuiModOptionString>().Init<OuiModOptions>(
					EmoteModModule.Settings.emote3,
					v => EmoteModModule.Settings.emote3 = v,
					12,
					1
				);
			}));

			menu.Add(new TextMenu.Button($"5. {EmoteModModule.Settings.emote4}").Pressed(() => {
				Audio.Play(SFX.ui_main_savefile_rename_start);
				menu.SceneAs<Overworld>().Goto<OuiModOptionString>().Init<OuiModOptions>(
					EmoteModModule.Settings.emote4,
					v => EmoteModModule.Settings.emote4 = v,
					12,
					1
				);
			}));

			menu.Add(new TextMenu.Button($"6. {EmoteModModule.Settings.emote5}").Pressed(() => {
				Audio.Play(SFX.ui_main_savefile_rename_start);
				menu.SceneAs<Overworld>().Goto<OuiModOptionString>().Init<OuiModOptions>(
					EmoteModModule.Settings.emote5,
					v => EmoteModModule.Settings.emote5 = v,
					12,
					1
				);
			}));

			menu.Add(new TextMenu.Button($"7. {EmoteModModule.Settings.emote6}").Pressed(() => {
				Audio.Play(SFX.ui_main_savefile_rename_start);
				menu.SceneAs<Overworld>().Goto<OuiModOptionString>().Init<OuiModOptions>(
					EmoteModModule.Settings.emote6,
					v => EmoteModModule.Settings.emote6 = v,
					12,
					1
				);
			}));

			menu.Add(new TextMenu.Button($"8. {EmoteModModule.Settings.emote7}").Pressed(() => {
				Audio.Play(SFX.ui_main_savefile_rename_start);
				menu.SceneAs<Overworld>().Goto<OuiModOptionString>().Init<OuiModOptions>(
					EmoteModModule.Settings.emote7,
					v => EmoteModModule.Settings.emote7 = v,
					12,
					1
				);
			}));

			menu.Add(new TextMenu.Button($"9. {EmoteModModule.Settings.emote8}").Pressed(() => {
				Audio.Play(SFX.ui_main_savefile_rename_start);
				menu.SceneAs<Overworld>().Goto<OuiModOptionString>().Init<OuiModOptions>(
					EmoteModModule.Settings.emote8,
					v => EmoteModModule.Settings.emote8 = v,
					12,
					1
				);
			}));

			menu.Add(new TextMenu.Button($"10. {EmoteModModule.Settings.emote9}").Pressed(() => {
				Audio.Play(SFX.ui_main_savefile_rename_start);
				menu.SceneAs<Overworld>().Goto<OuiModOptionString>().Init<OuiModOptions>(
					EmoteModModule.Settings.emote9,
					v => EmoteModModule.Settings.emote9 = v,
					12,
					1
				);
			}));
	...
	public class EmoteSettings : EverestModuleSettings
	{
		...
		{
			menu.Add(new TextMenu.Slider(Dialog.Clean("settings_speed_name"), Speed.speedFormatter, 0, Speed.speeds.Length - 1, EmoteModModule.Settings.AnimationSpeed)
				.Change(id => EmoteModModule.Settings.AnimationSpeed = id));
		}
