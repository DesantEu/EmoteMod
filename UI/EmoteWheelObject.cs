...
namespace EmoteMod.UI
{
    public class EmoteWheelObject : Entity
    {
        ...
        public EmoteWheelObject(Entity tracking)
            : base(Vector2.Zero)
        {
            Tracking = tracking;
        ...
        public override void Render()
        {
            ...
            {
                // get selected
                Angle = EmoteWheel.JoystickEmoteWheel.Value.Angle();
            ...
            // high quality emotes
            if (EmoteModModule.Settings.EmoteWheelHighRes)
            {
            ...
            for (int i = 0; i < emotes.Length; i++)
            {
                ...
                Sprite.Animation sanim = PlayerHelper.getAnimationByName(emote);
