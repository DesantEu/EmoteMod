...
namespace Celeste.Mod.EmoteMod
{
    ...
    public class EmoteSettings : EverestModuleSettings
    {
        ...
        //public string[] EmoteBindings { get; set; } = new string[] {
        //    "spin", "sleep", "wakeup",
        //    "laugh", "idlea", "idleb",
        //    "idlec", "tired", "hug",
        //    "fallfast" };

        //public ButtonBinding[] KeyboardBindings { get; set; } = new ButtonBinding[] {
        //    new ButtonBinding(0, Keys.NumPad0), new ButtonBinding(0, Keys.NumPad1), new ButtonBinding(0, Keys.NumPad2),
        //    new ButtonBinding(0, Keys.NumPad3), new ButtonBinding(0, Keys.NumPad4), new ButtonBinding(0, Keys.NumPad5),
        //    new ButtonBinding(0, Keys.NumPad6), new ButtonBinding(0, Keys.NumPad7), new ButtonBinding(0, Keys.NumPad8),
        //    new ButtonBinding(0, Keys.NumPad9)};
