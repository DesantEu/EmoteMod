...
namespace EmoteMod.Features
{
    public static class EmoteWheel
    {
        ...
        private static void Player_Update(On.Celeste.Player.orig_Update orig, Player self)
        {
            ...
            {
                // cool key feture
                if (EmoteModModule.Settings.EmoteWheelBinding.Buttons.Count != 0
                && MInput.GamePads[0].Pressed(EmoteModModule.Settings.EmoteWheelBinding.Buttons[0]))
                {
                ...
                // show
                Wheel.Shown = EmoteModModule.Settings.EmoteWheel && joystickActive
        ...
        public static void Send(int index, Player player)
        {
            ...
            if (0 <= index && index < emotes.Length)
                Emote.DoEmote(EmoteModModule.Settings.Emotes[index].GetInfo(), false, player); // TODO
        }
